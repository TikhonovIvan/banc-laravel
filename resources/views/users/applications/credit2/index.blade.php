...
@section('title', 'BankLine | Все заявки Ипотечный кредит')
...
@section('content')
    ...
    <div class="container mt-150">
        ...
        <div class="row">
            <h3 class="text-center mb-5">Заявки по Ипотечным кредитам </h3>
        </div>

        <form action="{{ route('credit2.search') }}" method="GET" class="mb-4">
            <div class="row">
                <div class="col-md-2">
            ...
            <table class="table">
                ...
                @foreach($applications as $application)
                    <tr>
                        ...
                        <td class="text-center">{{$application->term_years}}</td>
