...
@section('title', 'BankLine | Заявки пользователя')
    ...
    >
        <div class="container pb-5">
            <div class="pt-50 pb-2">
                ...
                <div class="row">
                    <div class="col-12">
                        <h3 class="mb-5 text-center">Заявки пользователь</h3>
                        <p class="text-center">{{ $user->surname }} {{ $user->name }} {{ $user->patronymic }}</p>
                    </div>
                </div>
            </div>
