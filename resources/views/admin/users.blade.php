                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 160px;">
                            <a href="{{ route('account-admin.edit', $user->id) }}"  class="btn btn-success" style="height: 43px; padding: 15px; margin: auto">
                            ...
                            <a href="{{ route('credit-users.show', $user->id) }}"  class="btn btn-success" style="height: 43px; padding: 15px; margin: auto">
